            ...
            <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <table class="min-w-full divide-y divide-gray-300">
                        <thead>
                        <tr>
                            <th scope="col" class="p-2 text-left text-sm font-extrabold text-gray-600">Titulo</th>
                            <th scope="col" class="p-2 text-left text-sm font-extrabold text-gray-600">Nota</th>
                            <th scope="col" class="p-2 text-left text-sm font-extrabold text-gray-600">Categoria</th>
